...
\newcommand{\subheader}[1]{%
    \vspace{0.5em} % Adjust this to control space above the header
    \noindent\textbf{#1} % Makes the header bold
    \vspace{0.25em} % Adjust this to control space below the header
}
